<template>
  ...
  >
    ...
    <g opacity="0.1">
      <ellipse cx="479.42" cy="362.12" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="479.42" cy="271.07" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <ellipse cx="479.42" cy="252.86" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
    ...
    <g opacity="0.1">
      <ellipse cx="612.28" cy="330.26" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="612.28" cy="262.22" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <ellipse cx="612.28" cy="248.61" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
    ...
    <g opacity="0.1">
      <ellipse cx="1038.58" cy="322.12" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="1038.58" cy="231.07" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <ellipse cx="1038.58" cy="212.86" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
    ...
    <g opacity="0.1">
      <ellipse cx="928.72" cy="324.26" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="928.72" cy="256.22" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <ellipse cx="928.72" cy="242.61" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
    ...
    <g opacity="0.1">
      <ellipse cx="61.59" cy="322.12" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="61.59" cy="231.07" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <ellipse cx="61.59" cy="212.86" rx="11.38" ry="14.9" fill="var(--greyDark)" />
      <path
    ...
    <g opacity="0.1">
      <ellipse cx="171.44" cy="324.26" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
        ...
        fill="var(--greyDark)"
      />
      <ellipse cx="171.44" cy="256.22" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <ellipse cx="171.44" cy="242.61" rx="8.51" ry="11.13" fill="var(--greyDark)" />
      <path
    ...
    <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="var(--accent)" opacity="0.1" />
    <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="var(--accent)" opacity="0.1" />
    <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="var(--accent)" opacity="0.1" />
    <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="var(--accent)" opacity="0.1" />
    <path
    ...
    <path
      ...
      opacity="0.1"
    />
    <g class="group transition-transform duration-300 ease-in-out hover:-translate-y-2.5">
      <!-- Grauer Kreis -->
      <circle cx="779.73" cy="238.18" r="99.96" fill="var(--greyDark)" />
      ...
      <!-- Sprechblase für die erste Gruppe -->
      <g
        class="opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        style="transform: translate(60px, -30px)"
      >
        <!-- Rechteck für die Sprechblase -->
        <rect
          x="750"
          y="120"
          width="250"
        ...
        <polygon
          points="790,170 780,160 800,160"
          fill="white"
          stroke="var(--greyDark)"
          stroke-width="2"
          style="transform: translate(-25px, 10px)"
        />
        <!-- Telefonnummer in der Sprechblase -->
        <text
          x="875"
          y="148"
          font-family="Arial"
    ...
    <g class="group1 transition-transform duration-300 ease-in-out hover:-translate-y-2.5">
      <circle cx="550.08" cy="390.01" r="99.96" fill="var(--greyDark)" />
      <path
      ...
      <!-- Sprechblase für die zweite Gruppe -->
      <g
        class="opacity-0 group1-hover:opacity-100 transition-opacity duration-300"
        style="transform: translate(60px, -30px)"
      >
        <!-- Rechteck für die Sprechblase -->
        <rect
    ...
    <circle cx="312.85" cy="315.36" r="99.96" fill="var(--greyDark)" />
    <path
